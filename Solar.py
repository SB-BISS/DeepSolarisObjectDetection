...
class SolarDataset(utils.Dataset):
    ...
    def load_solar(self, dataset_dir, subset,filename='via_region_data.json'):
        ...
        annotations = json.load(open(os.path.join(dataset_dir, filename)))
        ...
        for a in annotations:
            ...
            polygons = [r['shape_attributes'] for r in a['regions'] if len(r['shape_attributes']['all_points_x'])>0]
...
def train(model):
    ...
    dataset_train.load_solar(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = SolarDataset()
    dataset_val.load_solar(args.dataset, "val")
    dataset_val.prepare()
